    ...
    def test_get_contrast(self) -> None:
        self.assertEqual(
            ...
            [
                ...
                Point(x=0.4745098, y=0.4781306),
                Point(x=0.5058824, y=0.5231392),
                Point(x=0.5372549, y=0.5672581),
                Point(x=0.5686275, y=0.6099641),
                Point(x=0.6000000, y=0.6508785),
                Point(x=0.6352941, y=0.6944571),
                Point(x=0.6705882, y=0.7352641),
                Point(x=0.7058824, y=0.7732604),
                Point(x=0.7450980, y=0.8122763),
                Point(x=0.7843137, y=0.8481296),
                Point(x=0.8235294, y=0.8810931),
                Point(x=0.8666667, y=0.9143509),
                Point(x=0.9098039, y=0.9447794),
                Point(x=0.9529412, y=0.9725984),
                Point(x=1.0000000, y=1.0000000),
            ],
        )

    ...
    def test_calculate_brightness(self) -> None:
        self.assertEqual(
            ...
            [
                ...
                Point(x=0.111111, y=0.044467),
                Point(x=0.150794, y=0.103154),
                Point(x=0.174603, y=0.171352),
                Point(x=0.190476, y=0.236449),
                Point(x=0.206349, y=0.302571),
                Point(x=0.253968, y=0.500938),
                Point(x=0.285714, y=0.626197),
                Point(x=0.309524, y=0.694778),
                Point(x=0.349206, y=0.775265),
                Point(x=0.412698, y=0.856236),
                Point(x=0.539683, y=0.931365),
                Point(x=0.666667, y=0.964267),
                Point(x=1.000000, y=1.000000),
            ],
        )
